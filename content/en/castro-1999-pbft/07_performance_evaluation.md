...
content_sha256: 515649e12efe9cd01155004231b742c0fa38eaae6979b38fd74f95088582aa6c
...
### 7.1 Experimental Setup {#castro-1999-pbft-s7-1 .section tag=0831}
...
### 7.2 Micro-Benchmark {#castro-1999-pbft-s7-2 .section tag=0832}
...
Table 1: Micro-benchmark results (in milliseconds); the percentage overhead is relative to the unreplicated case. {#castro-1999-pbft-tab-1 .table tag=0833}
...
### 7.3 Andrew Benchmark {#castro-1999-pbft-s7-3 .section tag=0834}
...
Table 2: Andrew benchmark: BFS vs BFS-nr. The times are in seconds. {#castro-1999-pbft-tab-2 .table tag=0835}
...
Table 3: Andrew benchmark: BFS vs NFS-std. The times are in seconds. {#castro-1999-pbft-tab-3 .table tag=0836}
