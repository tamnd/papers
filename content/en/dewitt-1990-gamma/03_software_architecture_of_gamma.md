...
content_sha256: ffdf4e121d3d64f2d9e9fd23b6462d05ef2660640b1aa277758aad8bf8803227
...
[^1]: Intel was forced to use such a design because the I/O system was added after the system had been completed and the only way of doing I/O was by using a empty socket on the board which did not have DMA access to memory.
...
Figure 2. Gamma Process Structure {#dewitt-1990-gamma-fig-2 .figure tag=0262}
...
### Ad-hoc and Embedded Query Interfaces {#dewitt-1990-gamma-s-ad-hoc-and-embedded-query-interfaces .section tag=0264}
...
### Query Execution {#dewitt-1990-gamma-s-query-execution .section tag=0265}
...
[^1]: Tuples are actually sent as 8K byte batches, except for the last batch.
